...
export const metadata: Metadata = {
  title: "Mahir Patel",
  description: "Mahir Patel - Developer Portfolio",
  keywords: ["Mahir Patel", "Serbyte", "Credit"],
  alternates: {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-white px-6 py-16 text-center text-gray-900">
      <div className="max-w-2xl space-y-4">
        ...
        <h1 className="text-2xl font-semibold">Web design by Mahir Patel</h1>
